    ...
    <div id={id} className="Education">
      ...
      <div className="Education__container">
        ...
        <p className="description-text">
          I spent two years taking computer science at Okanagan College,
          including courses in; Java, PHP, MySql, Visual Basic, C++, Data
          Structures, Computational Mathematics, Communications, Design
        ...
        <p className="description-text">
          ...
          environment. I successfully completed the three month project based
          ...
          private client. The languages and frameworks I learned included Web
          and App development with React. Apollo. Graphql. Postgresql. Meteor.
           Graphcool. Javascript. Node. TDD/BDD. Web Servers. Authentication.
          Redux. Security on the web.
        </p>
      </div>
    </div>
  );
